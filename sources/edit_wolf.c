...
/*   Updated: 2016/04/13 13:05:23 by cchameyr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		edit_backfront(t_wolf3d *w3d, t_ptd *pos, t_ptd *dir)
{
	...
	{
		if (w3d->def_map[(int)(pos->x + dir->x * mv_speed)][(int)pos->y] == 0)
			pos->x += w3d->r.dir.x * mv_speed;
		if (w3d->def_map[(int)(pos->x)][(int)(pos->y + dir->y * mv_speed)] == 0)
...
static void		edit_lateral(t_wolf3d *w3d, t_ptd *pos, t_ptd *dir)
{
	...
	{
		if (w3d->def_map[(int)(pos->x - dir->y * mv_speed)][(int)(pos->y)] == 0)
			pos->x -= dir->y * mv_speed;
		if (w3d->def_map[(int)(pos->x)][(int)(pos->y + dir->x * mv_speed)] == 0)
